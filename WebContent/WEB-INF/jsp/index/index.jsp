...
<a href="../login/login.html" class="btn btn-primary login-button">로그인</a> 
						...
						<div class="carousel-inner">
							<div class="item active">
								...
								<div class="carousel-caption">
									<h1>Cafe 4.0</h1>
									<h4>
										세 명의 아름다운 젊은이와 어정쩡한 중년이 모여 커피향과 아름다운 체험을 모토로 느낌있는 Cafe를
										만들었습니다.<br> 커피를 매개로 풍성한 맛과 향기가 있는 사람들의 어울림. Cafe 4.0으로
										모십니다.
									</h4>
								</div>
							</div>
							...
							<div class="item">
								...
								<div class="carousel-caption">
									<h2>르완다</h2>
									<p>
										천개의 고원으로 유명한 아프리카 고산지 르완다~!<br> 르완다는 아프리카 대륙의 중부 내륙에 위친한
										작은 나라입니다.<br> 식민지배를 용이하게 하고 종족간 갈등 유도한 결과 내부 대립에 이어 참혹한
										학살 이미지가 강한 곳입니다.<br> 하지만, 요즘 르완다는 아프리카 대륙 전체에서도 치안이 잘
										유지되는 곳입니다.<br> 아울러 우리와 유사한 역사적 경험과 부족한 자원을 지혜로 극복하고 점점
										아프리카에서 두각을 나타내는 곳이기도 합니다.
									</p>
								</div>
							</div>
							<div class="item">
								...
								<div class="carousel-caption">
									<h2>파치먼트 상태</h2>
									<p>
										커피는 나무에서 열매상태인 커피 체리를 따고,<br> 수세식 방식의 경우, 겉 껍질을 벗겨
										워싱스테이션이란 곳에서 씻고는 속 껍질 채로 말립니다.<br> 그 말린 콩을 '파치먼트'라고 하고,
										르완다 워싱스테이션에서 흔히 볼 수 있는 파치먼트를 말리고 있는 사진입니다.
									</p>
								</div>
							</div>
						</div>
				...
				<div class="navbar navbar-inverse navbar-static-top"
					...
					<nav class="collapse navbar-collapse bs-navbar-collapse"
						...
						<form class="navbar-form navbar-left" role="search">
							...
							<button type="submit" class="btn btn-warning">Submit</button>
						<span id="loginc"><font color="white">${USER_KEY.userEmail }님이 접속됨</font></font>	</span>
						<a href="../login/logout.html" class="btn btn-primary login-button">로그아웃</a>
						</form>
						
						
						<!-- <span id="loginButtons"><a href="../login/login.html"
							class="btn btn-primary login-button">로그인</a> <a
							href="../memberentry/memberEntry.html"
	...
	<section>\${USER_KEY.userEmail } = ${USER_KEY.userEmail }</section>
